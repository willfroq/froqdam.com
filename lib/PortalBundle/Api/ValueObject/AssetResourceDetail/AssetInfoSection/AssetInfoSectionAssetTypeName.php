...
final class AssetInfoSectionAssetTypeName
{
    public function __construct(
        ...
        public readonly string $assetTypeLink,
        ...
        Assert::string($this->assetTypeLink, 'Expected "assetTypeLink" to be a string, got %s');
