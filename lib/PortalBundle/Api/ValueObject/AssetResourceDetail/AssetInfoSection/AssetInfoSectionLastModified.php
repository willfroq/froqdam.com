...
final class AssetInfoSectionLastModified
{
    public function __construct(
        ...
        public readonly string $fileLastModified,
    ) {
        ...
        Assert::string($this->fileLastModified, 'Expected "fileLastModified" to be a string, got %s');
    }
}
