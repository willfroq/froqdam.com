    ...
    DefinitionAwarePropertyMappingInterface
{
    ...
    {
        /** @var AssetResourceMetadata $metadaData */
        foreach ($fc->getItems() as $metadaData) {
            if ($metadaData->getMetadataKey() === $this->getConfiguration(self::CONFIG_FIELD_COLLECTION_KEY)) {
                return $metadaData->getMetadataValue();
            }
        }
