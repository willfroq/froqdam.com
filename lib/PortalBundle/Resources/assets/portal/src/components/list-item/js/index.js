...
class ListItem extends UiComponent {
    constructor() {
        ...
        this.actionsDropdownClone = null;
        this.editPopupFormUrl = null;
        this.editPopupSubmitUrl = null;
    }
    ...
    render() {
        ...
        this.editPopupFormUrl = this.getAttribute('edit-popup-form-url');
        this.editPopupSubmitUrl = this.getAttribute('edit-popup-submit-url');
