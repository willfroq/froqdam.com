...
class ViewerFBX extends UiComponent {
    constructor() {
        super();
    ...
    initialize() {
        ...
        const fbxLoader = loadFBXModel(this.url, scene);
...
function loadFBXModel(url, scene) {
...
customElements.define("app-viewer-fbx", ViewerFBX);
